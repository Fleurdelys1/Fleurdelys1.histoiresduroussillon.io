...
window.addEventListener("load", () => {
    ...
    header[1].addEventListener("click", () => {window.open("Fleurdelys1.histoiresduroussillon.io/root/html/Categories.html")})
...
const openArticle = (num) =>{
    window.open("Fleurdelys1.histoiresduroussillon.io/root/html/art_"+num+".html",'_blank');
}